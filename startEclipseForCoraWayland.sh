...
if [ ! $USER ]; then
  	echo "You must specify the userName used when starting eclipse202206forcora1"
else
...
${CONTAINERRUNTIME} run --rm -ti --privileged  --ipc=host \
 ...
 -v /mnt/depot/cora/eclipse202206forcora1/workspace:/home/$USER/workspace\
 -v /mnt/depot/cora/eclipse202206forcora1/eclipse:/home/$USER/eclipse\
 -v /mnt/depot/cora/eclipse202206forcora1/.eclipse:/home/$USER/.eclipse\
 -v /mnt/depot/cora/eclipse202206forcora1/.saros:/home/$USER/.saros\
