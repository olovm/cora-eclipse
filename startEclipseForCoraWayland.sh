...
if [ ! $USER ]; then
  	echo "You must specify the userName used when starting eclipse202409forcora2"
else
...
${CONTAINERRUNTIME} run --rm -ti --privileged  --ipc=host \
 ...
 -v /mnt/depot/cora/eclipse202409forcora2/workspace:/home/$USER/workspace\
 -v /mnt/depot/cora/eclipse202409forcora2/eclipse:/home/$USER/eclipse\
 -v /mnt/depot/cora/eclipse202409forcora2/.eclipse:/home/$USER/.eclipse\
 -v /mnt/depot/cora/eclipse202409forcora2/.saros:/home/$USER/.saros\
 ...
 --name eclipse202409forcora2\
 eclipse202409forcora2 $2
 cd ../
fi
