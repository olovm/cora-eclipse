...
if [ ! $USER ]; then
  	echo "You must specify the userName used when starting eclipse202512forcora1"
else
	#${CONTAINERRUNTIME} run --rm -ti --privileged --ipc=host --env="QT_X11_NO_MITSHM=1"  -e DISPLAY=$DISPLAY \
cd eclipse202512forcora1
...
${CONTAINERRUNTIME} run --rm -ti --privileged  --ipc=host \
 ...
 -v /mnt/depot/cora/eclipse202512forcora1/workspace:/home/$USER/workspace\
 -v /mnt/depot/cora/eclipse202512forcora1/eclipse:/home/$USER/eclipse\
 -v /mnt/depot/cora/eclipse202512forcora1/.eclipse:/home/$USER/.eclipse\
 -v /mnt/depot/cora/eclipse202512forcora1/.saros:/home/$USER/.saros\
 ...
 --name eclipse202512forcora1\
 eclipse202512forcora1 $2
 cd ../
fi
