...
if [ ! $USER ]; then
  	echo "You must specify the userName used when starting eclipse202212forcora4"
else
	#${CONTAINERRUNTIME} run --rm -ti --privileged --ipc=host --env="QT_X11_NO_MITSHM=1"  -e DISPLAY=$DISPLAY \
cd eclipse202212forcora4
...
${CONTAINERRUNTIME} run --rm -ti --privileged  --ipc=host \
 ...
 -v /mnt/depot/cora/eclipse202212forcora4/workspace:/home/$USER/workspace\
 -v /mnt/depot/cora/eclipse202212forcora4/eclipse:/home/$USER/eclipse\
 -v /mnt/depot/cora/eclipse202212forcora4/.eclipse:/home/$USER/.eclipse\
 -v /mnt/depot/cora/eclipse202212forcora4/.saros:/home/$USER/.saros\
 ...
 --name eclipse202212forcora4\
 eclipse202212forcora4 $2
 cd ../
fi
