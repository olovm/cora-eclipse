...
if [ ! $USER ]; then
  	echo you must specify the userName to be used when building eclipse201809forcora6
elif [ ! $USERID ]; then
	...
	echo you must specify the dockergroupid to be used when building eclipse201809forcora6, use: getent group docker 
else
