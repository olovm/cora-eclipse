...
if [ ! $USER ]; then
  	echo "You must specify the userName used when building eclipseforcora3"
else
	...
	--env user=$USER -p 8080:8080 -p 9876:9876 -p 8090:8090 -p 8983:8983 --name eclipseforcora3 eclipseforcora3 $2
fi
