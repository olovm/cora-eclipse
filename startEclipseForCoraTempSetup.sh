...
if [ ! $USER ]; then
  	echo "You must specify the userName used when starting eclipse201906forcora3TempSetup"
else
cd eclipse201906forcora3
docker run --rm -ti --privileged --ipc=host --env="QT_X11_NO_MITSHM=1"  -e DISPLAY=$DISPLAY \
 ...
 --name eclipse201906forcora3TempSetup\
 eclipse201906forcora3
 cd ../
fi
