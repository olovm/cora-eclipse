...
if [ ! $USER ]; then
  	echo "You must specify the userName used when starting eclipse201909forcora2TempSetup"
else
cd eclipse201909forcora2
docker run --rm -ti --privileged --ipc=host --env="QT_X11_NO_MITSHM=1"  -e DISPLAY=$DISPLAY \
 ...
 --name eclipse201909forcora2TempSetup\
 eclipse201909forcora2
 cd ../
fi
