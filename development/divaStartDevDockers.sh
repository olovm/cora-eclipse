...
-e "JAVA_OPTS=\
-DapptokenVerifierURL=http://eclipse202103forcora3:8182/apptokenverifier/ \
-DbaseURL=http://eclipse202103forcora3:8082/diva/rest/ \
...
-e password="fedora" \
-e appTokenVerifierUrl="http://eclipse202103forcora3:8182/apptokenverifier/" \
-e baseUrl="http://eclipse202103forcora3:8082/diva/rest/" \
