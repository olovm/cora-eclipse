...
-e "JAVA_OPTS=\
-DapptokenVerifierURL=http://eclipse202106forcora2:8182/apptokenverifier/ \
-DbaseURL=http://eclipse202106forcora2:8082/diva/rest/ \
...
-e password="fedora" \
-e appTokenVerifierUrl="http://eclipse202106forcora2:8182/apptokenverifier/" \
-e baseUrl="http://eclipse202106forcora2:8082/diva/rest/" \
