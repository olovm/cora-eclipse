...
LOGIN_URL='http://localhost:8181/login/rest/apptoken/systemoneAdmin@system.cora.uu.se'
...
#LOGIN_URL='https://cora.alvin-portal.org/login/rest/apptoken/systemoneAdmin@system.cora.uu.se'
...
#LOGIN_URL='http://130.238.171.238:38181/login/rest/apptoken/systemoneAdmin@system.cora.uu.se'
