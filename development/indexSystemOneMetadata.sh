...
LOGIN_URL='http://localhost:8180/login/rest/apptoken/jsClientUser@system.cora.uu.se'
...
#LOGIN_URL='http://130.238.171.238:38180/login/rest/apptoken/jsClientUser@system.cora.uu.se'
