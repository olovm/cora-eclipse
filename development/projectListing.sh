...
DIVA_DEV_CONTAINER="diva-cora-docker-fedora diva-docker-mock-classic-postgresql diva-cora-docker-postgresql diva-cora-docker-fcrepo-postgresql diva-docker-classicfedorasynchronizer "
