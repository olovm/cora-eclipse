...
TIER0="cora-parent "
TIER1="cora-data cora-json cora-httphandler cora-userpicker cora-apptokenstorage cora-searchstorage cora-sqldatabase"
TIER2="cora-beefeater cora-bookkeeper cora-gatekeeper cora-gatekeeperserver"
