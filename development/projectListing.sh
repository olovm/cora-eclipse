...
COMMON_PURE_CONTAINER+="cora-docker-fedora cora-docker-rabbitmq"
...
ALL_JAVA=$PARENT0" "$ALL_COMMON" "$ALL_CORA" "$ALL_CORE" "$ALL_LOGIN" "$ALL_GATEKEEPER" "$ALL_BINARYCONVERTER" "
