...
INSTALLDIR=$PARENTDIR/eclipse202212forcora2
...
createArchiveReadableFile(){
	...
	echo "docker exec -u 0 eclipse202212forcora2 bindfs --map=root/$USER:@root/@$USER /tmp/sharedArchive/ /tmp/sharedArchiveReadable/" > $PARENTDIR/archiveReadable.sh
