...
INSTALLDIR=$PARENTDIR/eclipse202212forcora1
...
createArchiveReadableFile(){
	...
	echo "docker exec -u 0 eclipse202212forcora1 bindfs --map=root/$USER:@root/@$USER /tmp/sharedArchive/ /tmp/sharedArchiveReadable/" > $PARENTDIR/archiveReadable.sh
