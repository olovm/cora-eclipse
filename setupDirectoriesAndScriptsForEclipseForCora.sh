...
INSTALLDIR=$PARENTDIR/eclipse202303forcora3
...
createArchiveReadableFile(){
	...
	echo "docker exec -u 0 eclipse202303forcora3 bindfs --map=root/$USER:@root/@$USER /tmp/sharedArchive/ /tmp/sharedArchiveReadable/" > $PARENTDIR/archiveReadable.sh
