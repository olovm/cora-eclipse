...
INSTALLDIR=$PARENTDIR/eclipse202209forcora4
...
createArchiveReadableFile(){
	...
	echo "docker exec -u 0 eclipse202209forcora4 bindfs --map=root/$USER:@root/@$USER /tmp/sharedArchive/ /tmp/sharedArchiveReadable/" > $PARENTDIR/archiveReadable.sh
