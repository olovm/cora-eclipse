...
INSTALLDIR=$PARENTDIR/eclipse202303forcora2
...
createArchiveReadableFile(){
	...
	echo "docker exec -u 0 eclipse202303forcora2 bindfs --map=root/$USER:@root/@$USER /tmp/sharedArchive/ /tmp/sharedArchiveReadable/" > $PARENTDIR/archiveReadable.sh
