...
INSTALLDIR=$PARENTDIR/eclipse202309forcora1
...
createArchiveReadableFile(){
	...
	echo "docker exec -u 0 eclipse202309forcora1 bindfs --map=root/$USER:@root/@$USER /tmp/sharedArchive/ /tmp/sharedArchiveReadable/" > $PARENTDIR/archiveReadable.sh
